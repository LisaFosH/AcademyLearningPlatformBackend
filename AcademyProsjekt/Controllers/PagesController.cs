...
namespace AcademyProsjekt.Controllers
{
    public class PagesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,LearningOutcomes,LearningMaterial")] Page page)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,LearningOutcomes,LearningMaterial")] Page page)
        {
            if (id != page.Id)
            {
                return NotFound();
